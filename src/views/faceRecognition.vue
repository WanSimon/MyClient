          ...
          if(msg.facematchinfo.is_result == 1 && !this.recognitionResult){
            ...
            if(this.api.mode === 2){
              ...
              try{
                ...
                setTimeout(()=>{this.$router.push({name: 'admin',params:{op_account_id:this.$route.params.op_account_id}});},1000);
              }catch (e){
                console.error('进入维护模式失败',e)
              }
              ...
              if(this.$route.params.type=='pickupCode'){
                ...
                setTimeout(()=>{this.$router.push({name: 'pickupCode'});},1000);
              }else {
                this.face_success = true;
                setTimeout(()=>{this.$router.push({name: 'productList'});},1000);
              }
            }
          }
        };
