<template>
  <div class="pickupCode">
    <topbar style="flex-shrink: 1;" :pageName="pageName" hideBack=true></topbar>
    <div class="content">
      <div class="left-item">
    ...
    methods:{
      ...
      async pickup(){
        ...
        try{
          ...
          this.$router.push({name:'customerProductList',params:{code:this.code,list:data.pick_up_product_list_info,order_id:data.order_id,lock_product:data.lock_product}});
        }
        catch (e){
      ...
      async startScan(){
        try{
          ...
          console.error('scanqrcode fail,e=',e);
        }
      },
      async stopScan(){
        try{
          ...
          console.error('stop_scan_qrcode fail,e=',e);
        }
      }
    },
    async mounted(){
